...
- **Manage employees** — Add, view, and delete employees with name, email, and department (Marketing, Technology, Finance, Operations, HR).
- **Track attendance** — View and mark daily attendance (present/absent) per employee, with filtering by month and year.
...
Keep this terminal running. The API is available at `http://localhost:8000/employee/` and the admin at `http://localhost:8000/admin/`.
